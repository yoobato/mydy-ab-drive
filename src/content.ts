...
export const articles: Article[] = [
  ...
  },
  {
    ...
    parkingSigns: [
      {
        kind: "no-stopping", signText: { ko: "검은 팔각형에 빨간 금지 표시, 평일 7:00–9:00 및 16:00–18:00 양방향 정차금지", en: "Black octagon with red prohibition symbol; no stopping both directions 7:00–9:00 and 16:00–18:00 Monday–Friday" },
        title: { ko: "정차 금지 — 팔각형 기호", en: "No Stopping — octagon symbol" },
      ...
      {
        kind: "no-parking", signText: { ko: "P에 빨간 금지 표시, 평일 9:00–16:00 양방향 주차금지", en: "Letter P with red prohibition symbol; no parking both directions 9:00–16:00 Monday–Friday" },
        title: { ko: "주차 금지 — P 기호", en: "No Parking — P symbol" },
      ...
      {
        kind: "time-limit", signText: { ko: "초록색 원 안 P, 30분, 양방향", en: "Green circled P, 30 minute limit, both directions" },
        title: { ko: "시간·요일·최대 체류", en: "Time, day and maximum stay" },
        meaning: { ko: "초록색 원 안의 P는 주차 허용을 뜻하고, 30 min 같은 숫자는 최대 주차시간입니다.", en: "A P inside a green circle permits parking; a value such as 30 min is the maximum stay." },
        check: { ko: "자정을 넘는 시간대와 공휴일 예외 문구도 확인합니다.", en: "Watch for overnight ranges and holiday exceptions." },
      },
      {
        kind: "arrows", signText: { ko: "주차금지와 정차금지 표지 아래의 왼쪽·오른쪽·양방향 화살표", en: "Left, right and both-direction arrows below no-parking and no-stopping symbols" },
      ...
      {
        kind: "paid", signText: { ko: "Pay by plate, Zone 2598 유료주차", en: "Pay by plate paid parking, Zone 2598" },
      ...
      {
        kind: "loading", signText: { ko: "주차금지 기호, 초록색 Loading Zone, 최대 20분, 오른쪽 방향", en: "No-parking symbol, green Loading Zone, 20 minute maximum, right direction" },
      ...
      {
        kind: "permit", signText: { ko: "주차금지 양방향, 허가 차량 제외", en: "No parking both directions, except by permit" },
      ...
      {
        kind: "accessible", signText: { ko: "파란색 장애인 주차, 허가증 필요, 왼쪽 8미터", en: "Blue accessible parking sign, permit required, 8 metres to the left" },
      ...
      {
        kind: "reserved", signText: { ko: "파란색 버스 그림, 왼쪽 Bus Zone", en: "Blue bus symbol with Bus Zone to the left" },
        title: { ko: "버스·택시 등 전용구역", en: "Bus, taxi and other reserved zones" },
        meaning: { ko: "표지에 적힌 허가 차량 외에는 정차하거나 주차할 수 없습니다. 그림은 Calgary의 Bus Zone 표지 예시입니다.", en: "Vehicles other than the class named on the sign may not stop or park. The illustration shows Calgary's Bus Zone example." },
        check: { ko: "Bus Zone에서는 승객을 잠깐 태우거나 내리는 것도 허용되지 않습니다. 택시·소방구역도 각 표지를 따릅니다.", en: "Even momentary passenger pickup or drop-off is prohibited in a Bus Zone. Follow the separate signs for taxi and fire zones." },
      },
      {
        kind: "snow-route", signText: { ko: "눈송이 Snow Route, When Declared, 주차금지", en: "Snowflake Snow Route, When Declared, no parking" },

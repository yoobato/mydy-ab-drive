...
export const expandedArticles: Article[] = [
  ...
  },
  {
    ...
    title: { ko: "고속도로 진출과 비상 갓길", en: "Highway exits and emergency shoulders" },
    summary: { ko: "출구 감속은 감속차로에서 하고, 비상정차 차로는 실제 긴급상황에만 사용합니다.", en: "Slow in the deceleration lane and use the emergency shoulder only for urgent stops." },
    takeaway: { ko: "출구를 놓쳤다면 다음 출구로 가세요. 고속도로에서 멈추거나 후진하지 마세요.", en: "If you miss an exit, take the next one. Never stop or reverse on a highway." },
    steps: {
      ko: ["출구보다 충분히 앞서 올바른 차로로 이동하고 방향지시등을 켭니다.", "감속차로에 완전히 들어간 뒤 대부분의 감속을 합니다.", "고장으로 갓길에 정차하면 차선을 최대한 벗어나 비상등을 켜고 안전한 위치로 이동합니다."],
      en: ["Move into the correct lane and signal well before the exit.", "Enter the deceleration lane before doing most of your slowing.", "For a breakdown, get fully off the travel lane, use hazards and move people to safety."],
    },
  ...
  },
  {
    ...
    title: { ko: "주의산만과 피로운전", en: "Distraction and fatigue" },
    summary: { ko: "손에 든 휴대폰·문자·GPS 입력 등은 빨간불에 정차 중일 때도 금지되며, 피로 역시 판단과 반응을 늦춥니다.", en: "Hand-held phones, texting and GPS entry are prohibited even at red lights, while fatigue also slows judgement and reaction." },
    takeaway: { ko: "조작이 필요하면 안전하고 합법적인 장소에 주차한 뒤 하세요.", en: "If a task needs your attention, park in a safe and legal place first." },
    steps: {
      ko: ["출발 전에 목적지·음악·온도를 설정하고 휴대폰은 손이 닿지 않는 곳에 둡니다.", "졸림, 잦은 하품, 차선 유지 실패가 보이면 다음 안전한 장소에서 쉬어갑니다.", "장거리 운전은 교대 운전자와 휴식 지점을 미리 정하고 무리한 도착시간을 잡지 않습니다."],
      en: ["Set navigation, audio and climate before moving and put the phone out of reach.", "If you yawn repeatedly, drift or miss signs, stop at the next safe place to rest.", "For long trips, plan breaks or a second driver and avoid an unrealistic arrival deadline."],
    },
    ...
    keywords: ["휴대폰", "문자", "gps", "피로운전", "졸음", "distracted driving", "fatigue"], sourceUrl: DISTRACTED_URL, sourceKinds: ["guide", "alberta"],
  },
  {
